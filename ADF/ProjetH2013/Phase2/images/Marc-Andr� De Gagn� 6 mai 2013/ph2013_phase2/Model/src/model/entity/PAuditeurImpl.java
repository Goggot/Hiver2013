...
import model.view.lecture.Seq_coordRowImpl;
  ...
  extends EntityImpl
{
    ...
    { 
      if (operation==DML_INSERT)
      {
        { 
          ...
          int NEXT_ID = empSeq.getSequenceNumber().add(1).intValue();setNocoord(NEXT_ID);
        }
  ...
  /**
   * Validation method for Codeauditeur.
   */
/* public boolean validateCodeauditeur(String codeauditeur)
  {
    boolean result = true;
    if(codeauditeur.compareToIgnoreCase(this.getCodeauditeur()))
    {
      result=false;
    }
    return result;
  ...
  public static final int SEQ_COORD1 = AttributesEnum.Seq_coord1.index();
  ...
  {
    return EntityDefImpl.findDefObject("model.entity.PAuditeur");
  }
  ...
  /**
   * Gets the view accessor <code>RowSet</code> Seq_coord1.
   */
  public RowSet getSeq_coord1()
  {
    return (RowSet) getAttributeInternal(SEQ_COORD1);
  }
