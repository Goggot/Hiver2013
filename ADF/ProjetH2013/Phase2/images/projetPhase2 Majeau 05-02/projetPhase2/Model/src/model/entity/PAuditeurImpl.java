...
import model.view.seq_coordRowImpl;
  ...
  extends EntityImpl
{
  ...
  {
      /*SequenceImpl empSeq=new SequenceImpl("p_seq_aud", getDBTransaction());
      setNoauditeur(empSeq.getSequenceNumber().intValue());*/
     /*int  NEXT_ID =0;*/
    /* SequenceImpl empSeq2=new SequenceImpl("p_seq_coord", getDBTransaction());
    int NEXT_ID = empSeq2.getSequenceNumber().intValue();
  ...
  protected void doDML(int operation, TransactionEvent e)
  {
    ...
    { 
  SequenceImpl empSeq2=new SequenceImpl("p_seq_coord", getDBTransaction());
  int NEXT_ID = empSeq2.getSequenceNumber().add(1).intValue();
