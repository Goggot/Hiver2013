...
(
  PARTITION ORDERS_PRE_2007 VALUES LESS THAN (TO_DATE('01/01/2007', 'MM/DD/YYYY')) NOCOMPRESS  
, PARTITION ORDERS_2007 VALUES LESS THAN (TO_DATE('01/01/2008', 'MM/DD/YYYY')) NOCOMPRESS  
);
