...
Rem NAME
Rem   Sample_V3.sql
Rem   référence: summit2.sql (de Forms 4.5)
Rem 
Rem FUNCTION
...
Rem	  sperreault 10/09/00 -  Ajout de données dans les tables s_region et s_warehouse
Rem     sperreault 21/09/00 -  Modification des dates dans la table s_emp
set feedback off
prompt Dropping tables and sequences.  Please wait.
...
Rem Drop foreign key constraints.

ALTER TABLE s_dept DROP CONSTRAINT s_dept_region_id_fk;
ALTER TABLE s_emp DROP CONSTRAINT s_emp_manager_id_fk;
ALTER TABLE s_emp DROP CONSTRAINT s_emp_dept_id_fk;
ALTER TABLE s_emp DROP CONSTRAINT s_emp_title_fk;
ALTER TABLE s_customer DROP CONSTRAINT s_sales_rep_id_fk;
ALTER TABLE s_customer DROP CONSTRAINT s_customer_region_id_fk;
ALTER TABLE s_ord DROP CONSTRAINT s_ord_customer_id_fk;
ALTER TABLE s_ord DROP CONSTRAINT s_ord_sales_rep_id_fk;
ALTER TABLE s_product DROP CONSTRAINT s_product_image_id_fk;
ALTER TABLE s_product DROP CONSTRAINT s_product_longtext_id_fk;
ALTER TABLE s_item DROP CONSTRAINT s_item_ord_id_fk;
ALTER TABLE s_item DROP CONSTRAINT s_item_product_id_fk;
ALTER TABLE s_warehouse DROP CONSTRAINT s_warehouse_manager_id_fk;
ALTER TABLE s_warehouse DROP CONSTRAINT s_warehouse_region_id_fk;
ALTER TABLE s_inventory DROP CONSTRAINT s_inventory_product_id_fk;
ALTER TABLE s_inventory DROP CONSTRAINT s_inventory_warehouse_id_fk;
...
prompt Tables and sequences dropped.
set feedback on
...
INSERT INTO s_dept VALUES (   46, 'Assistant Operations', 1);
...
(id                         NUMBER(7) 
 ...
 commission_pct             NUMBER(4, 2),
     ...
     CONSTRAINT s_emp_commission_pct_ck
        CHECK (commission_pct IN (0, 10, 12.5, 15, 17.5, 20)));

INSERT INTO s_emp VALUES (
  1, 'Velasquez', 'Carmen', 'cvelasqu',
   to_date('03/03/1990 8:30', 'dd/mm/yyyy hh24:mi'), NULL, NULL, 'President',
   50, 62500, NULL);
INSERT INTO s_emp VALUES (
   2, 'Ngao', 'LaDoris', 'lngao',
   to_date('08/03/1990','dd/mm/yyyy'), NULL, 1, 'VP, Operations',
   41, 51450, NULL);
INSERT INTO s_emp VALUES (
   3, 'Nagayama', 'Midori', 'mnagayam',
   to_date('17/06/1991','/dd/mm/yyyy'), NULL, 1, 'VP, Sales',
   31, 51400, NULL);
INSERT INTO s_emp VALUES (
   4, 'Quick-To-See', 'Mark', 'mquickto', 
   to_date('07/04/1999','dd/mm/yyyy'), NULL, 1, 'VP, Finance', 
   10, 51450, NULL);
INSERT INTO s_emp VALUES (
   5, 'Ropeburn', 'Audry', 'aropebur',
   to_date('04/03/1995','dd/mm/yyyy'), NULL, 1, 'VP, Administration',
   50, 51550, NULL);
INSERT INTO s_emp VALUES (
...
INSERT INTO s_emp VALUES (
   26, 'Hart', 'Johnny', 'jhar',
   to_date('18/01/1998','dd/mm/yyyy'), NULL, 2, 'Warehouse Manager',
   46, 35200, NULL);
INSERT INTO s_emp VALUES (
   7, 'Menchu', 'Roberta', 'rmenchu',
   to_date('14/05/2000','dd/mm/yyyy'), NULL, 2, 'Warehouse Manager',
   42, 31250, NULL);
INSERT INTO s_emp VALUES (
   8, 'Biri', 'Ben', 'bbiri',
...
INSERT INTO s_emp VALUES (
   ...
   to_date('08/03/1990','dd/mm/yyyy'), NULL, 6, 'Stock Clerk',
   41, 19940, NULL);
INSERT INTO s_emp VALUES (
   18, 'Nozaki', 'Akira', 'anozaki',
   to_date('09/02/1995','dd/mm/yyyy'), NULL, 7, 'Stock Clerk',
   42, 21200, NULL);
INSERT INTO s_emp VALUES (
   19, 'Patel', 'Vikram', 'vpatel',
   to_date('06/08/1997','dd/mm/yyyy'), NULL, 7, 'Stock Clerk',
   42, 19795, NULL);
INSERT INTO s_emp VALUES (
   20, 'Newman', 'Chad', 'cnewman',
   to_date('21/07/1995','dd/mm/yyyy'), NULL, 8, 'Stock Clerk',
   43, 19750, NULL);
INSERT INTO s_emp VALUES (
   21, 'Markarian', 'Alexander', 'amarkari',
   to_date('26/05/2000','dd/mm/yyyy'), NULL, 8, 'Stock Clerk',
   43, 19850, NULL);
INSERT INTO s_emp VALUES (
...
INSERT INTO s_emp VALUES (
   ...
   to_date('17/10/1994','dd/mm/yyyy'), NULL, 9, 'Stock Clerk',
   34, 19795, NULL);
INSERT INTO s_emp VALUES (
   24, 'Dancs', 'Bela', 'bdancs',
   to_date('17/03/1991','dd/mm/yyyy'), NULL, 10, 'Stock Clerk',
   45, 19860, NULL);
INSERT INTO s_emp VALUES (
...
INSERT INTO s_inventory VALUES (   40422, 101, 0, 350, 600, 'Phenomenal sales...', to_date('08/02/93','dd/mm/yyyy'));
...
INSERT INTO s_inventory VALUES (   50532, 101, 0, 100, 175, 'Wait for Spring.', to_date('12/04/93','dd/mm/yyyy'));
...
INSERT INTO s_inventory VALUES (   30433, 401, 0, 100, 175, 'A defective shipment was sent to Hong Kong ' ||
   'and needed to be returned. The soonest ACME can turn this around is ' ||
   'early February.', to_date('07/09/2000','dd/mm/yyyy'));
...
INSERT INTO s_item VALUES (   100, 2, 10013, 380, 40, 40);
INSERT INTO s_item VALUES (   100, 3, 10021, 14, 500, 500);
INSERT INTO s_item VALUES (   100, 5, 30326, 582, 6, 6);
...
INSERT INTO s_item VALUES (   109, 4, 30326, 582, 15, 15);
INSERT INTO s_item VALUES (   109, 2, 10012, 175, 60, 60);
...
INSERT INTO s_ord VALUES (
   100, 204, to_date('31/08/2004','dd/mm/yyyy'), to_date('10/09/2004','dd/mm/yyyy'),
   11, 118592, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   101, 205, to_date('31/08/2004','dd/mm/yyyy'), to_date('15/09/2004','dd/mm/yyyy'),
   14, 8056.6, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   102, 206, to_date('01/09/2004','dd/mm/yyyy'), to_date('08/09/2004','dd/mm/yyyy'),
   15, 8335, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   103, 208, to_date('02/09/2004','dd/mm/yyyy'), to_date('22/09/2004','dd/mm/yyyy'),
   15, 377, 'CASH', 'Y');
INSERT INTO s_ord VALUES (
   104, 208, to_date('03/09/2004','dd/mm/yyyy'), to_date('23/09/2004','dd/mm/yyyy'),
   15, 32430, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   105, 209, to_date('04/09/2004','dd/mm/yyyy'), to_date('18/09/2004','dd/mm/yyyy'),
   11, 2722.24, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   106, 210, to_date('07/09/2004','dd/mm/yyyy'), to_date('15/09/2004','dd/mm/yyyy'),
   12, 15634, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   107, 211, to_date('07/09/2004','dd/mm/yyyy'), to_date('21/09/2004','dd/mm/yyyy'),
   15, 142171, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   108, 212, to_date('07/09/2000','dd/mm/yyyy'), to_date('10/09/2000','dd/mm/yyyy'),
   13, 149570, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   109, 213, to_date('08/09/2004','dd/mm/yyyy'), to_date('28/09/2004','dd/mm/yyyy'),
   11, 62165, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   110, 214, to_date('09/09/2004','dd/mm/yyyy'), to_date('21/09/2004','dd/mm/yyyy'),
   11, 1539.13, 'CASH', 'N');
INSERT INTO s_ord VALUES (
   111, 204, to_date('09/09/2004','dd/mm/yyyy'), to_date('21/09/2004','dd/mm/yyyy'),
   11, 2770, 'CASH', 'N');
INSERT INTO s_ord VALUES (
   97, 201, to_date('28/08/2004','dd/mm/yyyy'), to_date('17/09/2004','dd/mm/yyyy'),
   12, 84000, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   98, 202, to_date('31/08/2004','dd/mm/yyyy'), to_date('10/09/2004','dd/mm/yyyy'),
   14, 595, 'CASH', 'Y');
INSERT INTO s_ord VALUES (
   99, 203, to_date('31/08/2004','dd/mm/yyyy'), to_date('18/09/2004','dd/mm/yyyy'),
   14, 7707, 'CREDIT', 'Y');
INSERT INTO s_ord VALUES (
   112, 210, to_date('31/08/2004','dd/mm/yyyy'), to_date('10/09/2004','dd/mm/yyyy'),
   12, 550, 'CREDIT', 'Y');
COMMIT;

...
INSERT INTO s_product VALUES (   10011, 'Bunny Boot',   'Beginner''s ski boot',
   518, 1001,   150, NULL);
INSERT INTO s_product VALUES (   10012, 'Ace Ski Boot',   'Intermediate ski boot',
   519, 1002,   200, NULL);
INSERT INTO s_product VALUES (   10013, 'Pro Ski Boot',   'Advanced ski boot',
   520, 1003,   410, NULL);
INSERT INTO s_product VALUES (   10021, 'Bunny Ski Pole',   'Beginner''s ski pole',
   528, 1011,   16.25, NULL);
INSERT INTO s_product VALUES (   10022, 'Ace Ski Pole',   'Intermediate ski pole',
   529, 1012,   21.95, NULL);
INSERT INTO s_product VALUES (   10023, 'Pro Ski Pole',   'Advanced ski pole',
   530, 1013,   40.95, NULL);
INSERT INTO s_product VALUES (   20106, 'Junior Soccer Ball',   'Junior soccer ball',
   613, NULL,   11, NULL);
INSERT INTO s_product VALUES (   20108, 'World Cup Soccer Ball',   'World cup soccer ball',
   615, NULL,   28, NULL);
INSERT INTO s_product VALUES (   20201, 'World Cup Net',   'World cup net',
   708, NULL,   123, NULL);
INSERT INTO s_product VALUES (   20510, 'Black Hawk Knee Pads',   'Knee pads, pair',
   1017, NULL,   9, NULL);
INSERT INTO s_product VALUES (   20512, 'Black Hawk Elbow Pads',   'Elbow pads, pair',
   1019, NULL,   8, NULL);
INSERT INTO s_product VALUES (   30321, 'Grand Prix Bicycle',   'Road bicycle',
   828, 1291,   1669, NULL);
INSERT INTO s_product VALUES (   30326, 'Himalaya Bicycle',   'Mountain bicycle',
   833, 1296,   582, NULL);
INSERT INTO s_product VALUES (   30421, 'Grand Prix Bicycle Tires',   'Road bicycle tires',
   927, NULL,   16, NULL);
INSERT INTO s_product VALUES (   30426, 'Himalaya Tires',   'Mountain bicycle tires',
   933, NULL,   18.25, NULL);
INSERT INTO s_product VALUES (   30433, 'New Air Pump',   'Tire pump',
   940, NULL,   20, NULL);
INSERT INTO s_product VALUES (   32779, 'Slaker Water Bottle',   'Water bottle',
   1286, NULL,   7, NULL);
INSERT INTO s_product VALUES (   32861, 'Safe-T Helmet',   'Bicycle helmet',
   1368, 1829,   60, NULL);
INSERT INTO s_product VALUES (   40421, 'Alexeyer Pro Lifting Bar',   'Straight bar',
   928, 1381,   65, NULL);
INSERT INTO s_product VALUES (   40422, 'Pro Curling Bar',   'Curling bar',
   929, 1382,   50, NULL);
INSERT INTO s_product VALUES (   41010, 'Prostar 10 Pound Weight',   'Ten pound weight',
   517, NULL,   8, NULL);
INSERT INTO s_product VALUES (   41020, 'Prostar 20 Pound Weight',   'Twenty pound weight',
   527, NULL,   12, NULL);
INSERT INTO s_product VALUES (   41050, 'Prostar 50 Pound Weight',   'Fifty pound weight',
   557, NULL,   25, NULL);
INSERT INTO s_product VALUES (   41080, 'Prostar 80 Pound Weight',   'Eighty pound weight',
   587, NULL,   35, NULL);
INSERT INTO s_product VALUES (   41100, 'Prostar 100 Pound Weight',   'One hundred pound weight',
   607, NULL,   45, NULL);
INSERT INTO s_product VALUES (   50169, 'Major League Baseball',   'Baseball',
   676, 1119,   4.29, NULL);
INSERT INTO s_product VALUES (   50273, 'Chapman Helmet',   'Batting helmet',
   780, 1223,   22.89, NULL);
INSERT INTO s_product VALUES (   50417, 'Griffey Glove',   'Outfielder''s glove',
   924, 1367,   80, NULL);
INSERT INTO s_product VALUES (   50418, 'Alomar Glove',   'Infielder''s glove',
   925, 1368,   75, NULL);
INSERT INTO s_product VALUES (   50419, 'Steinbach Glove',   'Catcher''s glove',
   926, 1369,   80, NULL);
INSERT INTO s_product VALUES (   50530, 'Cabrera Bat',   'Thirty inch bat',
   1037, 1480,   45, NULL);
INSERT INTO s_product VALUES (   50532, 'Puckett Bat',   'Thirty-two inch bat',
   1039, 1482,   47, NULL);
INSERT INTO s_product VALUES (   50536, 'Winfield Bat',   'Thirty-six inch bat',
   1043, 1486,   50, NULL);
COMMIT;

...
INSERT INTO s_region VALUES (   1, 'Amérique du nord');
INSERT INTO s_region VALUES (   2, 'Amérique du sud');
INSERT INTO s_region VALUES (   3, 'Afrique');
INSERT INTO s_region VALUES (   4, 'Asie');
INSERT INTO s_region VALUES (   5, 'Europe');
INSERT INTO s_region VALUES (   6, 'Amérique Centrale');
COMMIT;

...
INSERT INTO s_warehouse VALUES (101, 1, NULL, 'Seattle', 'WA', 'USA', NULL, '1-206-927-3482', 6);
INSERT INTO s_warehouse VALUES (102, 1, NULL, 'New-York', 'NY', 'USA', NULL, '1-872-257-4362', 26);
INSERT INTO s_warehouse VALUES (10501, 5, '5 Modrany','Bratislava', NULL, 'Czechozlovakie',
   NULL, '1-381-21-204-6843', 10);
INSERT INTO s_warehouse VALUES (201, 2, '68 Via Centrale', 'Sao Paolo', NULL, 'Brésil',
   NULL, '1-55-11-340-8703', 7);
INSERT INTO s_warehouse VALUES (301, 3, '6921 King Way','Lagos', NULL, 'Niger',
   NULL, '1-27-41-453-7860', 8);
INSERT INTO s_warehouse VALUES (401, 4,'86 Chu Street','Hong Kong', NULL, 'Chine',
   NULL, '1-852-3476-9808', 9);
COMMIT;

